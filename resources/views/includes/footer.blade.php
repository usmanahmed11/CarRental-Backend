...
<table style="font-family: Helvetica, 'Open Sans', Arial; box-sizing: border-box; font-size: 12px; border-radius: 3px; background-color: #fff; margin: 0;" width="100%" cellspacing="0" cellpadding="0">
    <tbody>
        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px">
            <td style="font-family: Helvetica, 'Open Sans', Arial; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 20px;" valign="top">
...
<table style="font-family: Helvetica, 'Open Sans', Arial;- box-sizing: border-box; font-size: 12px; border-radius: 3px; background-color: #fff; margin: 0;" width="100%" cellspacing="0" cellpadding="0">
    <tbody>
        <tr style="font-family: Helvetica, 'Open Sans', Arial; box-sizing: border-box; font-size: 12px; margin: 0">
            <td style="font-family: Helvetica, 'Open Sans', Arial; box-sizing: border-box; font-size: 14px; vertical-align: top; color: #000; text-align: center; border-top: 1px solid #b5b9bd; margin: 0; padding: 0px; " valign="top">
                <div style="padding: 15px">
                    <p style="margin-bottom:0px ; margin-top:5px">Please contact usman.ahmed@nxb.com.pk If you find any issue with ChatOnix</p>
                    <p style="margin-top:5px">Copyright @2023 ChatOnix (Pvt.) Ltd.</p>
                </div>
            </td>
        </tr>
    </tbody>
